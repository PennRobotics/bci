...
%   Subject 1 - Filtering
sub_1_filtered = filter(b,a, Train_ECoG_1);
sub_1_glove = filter(b,a, Train_Glove_1);
sub_1_test = filter(b,a, Test_ECoG_1);

%   Subject 2 - Filtering
sub_2_filtered = filter(b,a, Train_ECoG_2);
sub_2_glove = filter(b,a, Train_Glove_2);
sub_2_test = filter(b,a, Test_ECoG_2);

%   Subject 3 - Filtering
sub_3_filtered = filter(b,a, Train_ECoG_3);
sub_3_glove = filter(b,a, Train_Glove_3);
sub_3_test = filter(b,a, Test_ECoG_3);
