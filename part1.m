...
nr_2_train   = session_2_train.data.rawChannels(1).getNrSamples;
nr_2_glove   = session_2_glove.data.rawChannels(1).getNrSamples;
nr_2_test    = session_2_test .data.rawChannels(1).getNrSamples;
...
nr_3_train   = session_3_train.data.rawChannels(1).getNrSamples;
nr_3_glove   = session_3_glove.data.rawChannels(1).getNrSamples;
nr_3_test    = session_3_test .data.rawChannels(1).getNrSamples;
